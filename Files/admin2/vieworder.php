...
<body>
    ...
    <center> 
        ...
        <p style="margin-left:-300px;"> <b style="font-size:20px;"><?php echo $status; ?></b> successfully</p>
    </div>
    <hr>
...
$image=$fetch3['product_image'];
    ...
    <hr>
        ...
        <h3><a href="orders.php" style="color:black; text-decoration:none;">GO BACK TO ORDERS PAGE</a></h3>
        </div>
</center>
