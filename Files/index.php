...
<div class="main_wrapper">
    ...
    <div class="menubar">
             <ul id ="menu">
                 <li><a style="font-size:23px;" href="index.php">Home</a></li>
                 <li><a  style="font-size:23px;" href="all_product.php">All products</a></li>
                 <?php if($loggedin){
                    echo "
                 <li><a style='font-size:23px;' href='viewCart.php'>View Cart</a></li>
                 <li><a style='font-size:23px;' href='myorders.php'>My Orders</a></li>
                 <li><a style='font-size:23px;' href='logout.php'>Logout</a></li>
                    ";
                 } 
                 else{
                    echo "
                    <li><a  style='font-size:23px;' href='login.php'>Login</a></li>
                    ";
                 }
...
<div class="content_wrapper">
    ...
    global $connection;
    $getproduct="SELECT * FROM product LIMIT 0,15";//select 15 random products for display
            ...
            if($loggedin){
                ...
                if($quaExistRows == 0) {
                    echo "<form action='function/cartmanagement.php' method='POST'>
                          <input type='hidden' name='addcode' value='".$pro_id. "'>
